<div class="card bg-transparent border-0 text-center">
    <div class="card-img">
        ...
        <ul class="card-social list-inline">
            ...
            @if ($member->tw_url != '')    
            <li class="list-inline-item"><a class="twitter" href="{{ $member->tw_url }}"><i class="fab fa-twitter"></i></a>
            </li>
            @endif

            @if ($member->in_url != '')
            <li class="list-inline-item"><a class="instagram" href="{{ $member->in_url }}"><i class="fab fa-instagram"></i></a>
            </li>
            @endif
        </ul>
        @endif
